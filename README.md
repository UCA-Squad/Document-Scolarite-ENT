...
- Mises à jour
  ...
  * 20/06/22
      - Ajout de choix supplémentaires pour la liste des semestres
      - Intégration de l'API de Docapost pour signer numériquement les documents. Activation et configuration dans le fichier .env
